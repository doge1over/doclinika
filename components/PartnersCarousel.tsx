...
export default function PartnersCarousel({ lang }: PartnersCarouselProps) {
    ...
    return (
        <section className="relative bg-gradient-to-br from-gray-50 to-gray-100 py-8 sm:py-10 pb-16 sm:pb-20 overflow-hidden">
            {/* Фон */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-20 left-20 w-48 sm:w-72 h-48 sm:h-72 bg-blue-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
                <div className="absolute top-40 right-20 w-48 sm:w-72 h-48 sm:h-72 bg-purple-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
                <div className="absolute bottom-20 left-1/3 w-48 sm:w-72 h-48 sm:h-72 bg-pink-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
            </div>
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="relative">
                    ...
                    <button
                        onClick={scrollLeft}
                        className="absolute -left-2 sm:-left-4 top-1/2 -translate-y-1/2 z-10 bg-gray-900 hover:bg-gray-800 text-white p-2 sm:p-3 rounded-full shadow-lg transition-all hover:scale-105"
                    ...
                    <button
                        onClick={scrollRight}
                        className="absolute -right-2 sm:-right-4 top-1/2 -translate-y-1/2 z-10 bg-gray-900 hover:bg-gray-800 text-white p-2 sm:p-3 rounded-full shadow-lg transition-all hover:scale-105"
                            ...
                            {duplicatedPartners.map((partner, index) => (
                                ...
                                >
                                    <div className="flex flex-col items-center text-center">
                                        {/* Логотип */}
                                        <div className="w-16 h-16 sm:w-24 sm:h-24 mb-2 sm:mb-3 bg-gray-50 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md overflow-hidden">
                                            <img
                                                src={partner.logo}
                                                alt={partner.name}
                                        ...
                                        {/* Название */}
                                        <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-2 sm:mb-3 min-h-[40px] sm:min-h-[48px] flex items-center justify-center line-clamp-2">
                                            {partner.name}
                                        </h3>
