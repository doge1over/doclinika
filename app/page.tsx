                    ...
                    <div className="flex justify-between items-center h-14 sm:h-16">
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            <div className="hidden lg:flex items-center gap-3">
                                ...
                                <a
                                    href="/zayavka-nir"
                                    className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-lg transition-all whitespace-nowrap"
                                >
                                    Заявка на НИР
                                </a>
                            </div>
                            ...
                            <div className="text-right">
                                ...
                                <a href={`mailto:${t.email}`} className="block text-xs text-gray-500 hover:text-blue-600 transition">
                                    {t.email}
                                </a>
                            </div>
                        </div>
