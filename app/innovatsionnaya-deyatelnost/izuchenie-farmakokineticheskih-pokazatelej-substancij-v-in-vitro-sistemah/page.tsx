...
export default function IzuchenieFarmakokinetikaInVitro() {
            ...
            <div className="bg-white border-b border-[#F28F20]/20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
                    <nav className="flex items-center text-sm text-gray-500 flex-wrap">
                        ...
                        <svg className="w-4 h-4 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                        <span className="text-gray-900 font-medium">Изучение фармакокинетических показателей субстанций в in vitro системах</span>
                    </nav>
                </div>
            </div>
                    ...
                    <article className="flex-1 min-w-0">
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                            ...
                            <div className="px-6 sm:px-8 py-6 sm:py-8" style={{ background: 'linear-gradient(to right, #F28F20, #e07d10)' }}>
                                <h1 className="text-2xl sm:text-3xl font-bold text-white">Изучение фармакокинетических показателей субстанций в in vitro системах</h1>
                            </div>
                            ...
                            <div className="px-6 sm:px-8 py-6 sm:py-8">
                                <div className="prose prose-lg max-w-none text-[#003366]">
                                    <p className="text-justify leading-relaxed mb-6">
                                        Исследования <em>in vitro</em> служат скрининговым методом для оценки роли биотрансформации в фармакокинетике лекарственных средств. Эти исследования должны предшествовать соответствующим исследованиям <em>in vivo</em> у человека, и необходимы для подготовки регистрационного досье.
                                    </p>

                                    <p className="text-justify leading-relaxed mb-6">
                                        Изучение фармакокинетических показателей субстанции (оригинальных соединений) в <em>in vitro</em> системах (ADME) позволяет оценить элементы всасывания, распределения, метаболизма и элиминации и, в ряде случаев, сократить объем исследований с использованием лабораторных животных. Исследования проводятся в соответствии с рекомендациями FDA, EMA, ICH и OECD.
                                    </p>

                                    {/* Изображение */}
                                    <div className="my-8 text-center">
                                        <img
                                            src="https://doclinika.ru/wp-content/uploads/2021/05/ADME.gif"
                                            alt="ADME - зависимость проницаемости от абсорбции"
                                            className="mx-auto max-w-full h-auto rounded-lg shadow-md"
                                        />
                                        <p className="mt-3 text-sm text-[#003366]">
                                            <a href="https://www.cyprotex.com/admepk/in-vitro-permeability/caco-2-permeability" target="_blank" rel="noopener noreferrer" className="text-[#F28F20] hover:underline">
                                                Зависимость проницаемости фармацевтических субстанций от абсорбции в организме человека (изображение получено из открытых информационных источников)
                                            </a>
                                        </p>
                                    </div>

                                    <p className="font-bold mb-4">
                                        Мы проводим следующие исследования фармакокинетики <em>in vitro</em>:
                                    </p>
                                    ...
                                    <p className="font-bold mb-4">
                                        Для успешного выполнения работ по изучению фармакокинетики <em>in vitro</em> будет:
                                    </p>
