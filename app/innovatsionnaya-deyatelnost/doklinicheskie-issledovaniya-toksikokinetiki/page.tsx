...
const workSteps = [
    ...
    'проведены соответствующие эксперименты на лабораторных животных (мыши, крысы, кролики, морские свинки, карликовые свиньи, собаки, кошки и др.)',
    ...
    'проведена валидация аналитического в соответствии с рекомендациями актуальных отечественных и зарубежных руководств',
    'проведен расчет фармакокинетических параметров и их статистическая оценка'
]

export default function DoklinicheskieIssledovaniyaToksikokinetiki() {
            ...
            <div className="bg-white border-b border-[#F28F20]/20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
                    <nav className="flex items-center text-sm text-gray-500 flex-wrap">
                        ...
                        <svg className="w-4 h-4 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                        <span className="text-gray-900 font-medium">Доклинические исследования токсикокинетики</span>
                    </nav>
                </div>
            </div>
                    ...
                    <article className="flex-1 min-w-0">
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                            ...
                            <div className="px-6 sm:px-8 py-6 sm:py-8" style={{ background: 'linear-gradient(to right, #F28F20, #e07d10)' }}>
                                <h1 className="text-2xl sm:text-3xl font-bold text-white">Доклинические исследования токсикокинетики</h1>
                            </div>

                            {/* Content */}
                            <div className="px-6 sm:px-8 py-6 sm:py-8">
                                <div className="prose prose-lg max-w-none text-[#000080]">
                                    <p className="text-justify leading-relaxed mb-6">
                                        Токсикокинетические исследования необходимы для описания системной экспозиции вещества, достигаемой у животных, и изучения ее связи с вводимой дозой и длительностью токсикологического исследования.
                                    </p>

                                    <p className="text-justify leading-relaxed mb-6">
                                        Исследование токсикокинетики позволяет изучить закономерности распределения лекарственных веществ в организме при их введении в высоких дозах, оценить основные токсикокинетические параметры и факторы, влияющие на распределение лекарственных веществ в организме животного.
                                    </p>

                                    <p className="text-justify leading-relaxed mb-6">
                                        Результаты токсикокинетических исследований важны для оценки потенциала накопления исследуемого вещества в тканях и/или органах, возможных путей метаболизма препарата и степени риска применения препарата (при его передозировке, при взаимодействии с другими препаратами).
                                    </p>

                                    {/* Изображение */}
                                    <div className="my-8 text-center">
                                        <img
                                            src="/images/toksikokinetika.jpg"
                                            alt="Кривые концентрация-время соматостатина"
                                            className="mx-auto max-w-full h-auto rounded-lg shadow-md"
                                            style={{ maxWidth: '330px' }}
                                        />
                                        <p className="mt-3 text-sm italic text-[#000080]">
                                            Кривые «концентрация-время» соматостатина после введения препарата в токсических дозах
                                        </p>
                                    </div>

                                    <p className="font-bold mb-4">
                                        Мы проводим исследования токсикокинетики в рамках изучения токсичности препаратов при многократном введении для оригинальных и воспроизведенных лекарственных средств (изучение сравнительной токсикокинетики).
                                    </p>

                                    <p className="font-bold mb-4">
                                        Для успешного выполнения работ по изучению токсикокинетики будет:
                                    </p>
