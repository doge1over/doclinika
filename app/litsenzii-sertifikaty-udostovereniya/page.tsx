...
const menuItems = [
    ...
    { href: '/litsenzii-sertifikaty-udostovereniya', title: 'Лицензии, сертификаты, удостоверения', active: true },
...
const documents = [
    {
        title: 'Ветеринарное удостоверение 2025/2026',
        url: 'https://doclinika.ru/wp-content/uploads/2025/11/Veterinarnoe-udostoverenie-247-0015701_131125.pdf'
    },
    {
        title: 'Лицензия на право оказания образовательных услуг по реализации программ дополнительного профессионального образования',
        url: 'https://doclinika.ru/wp-content/uploads/2018/12/Litsenziya.pdf'
    },
    {
        title: 'Сертификат и приложение к сертификату GLP 25.0265.026',
        url: 'https://doclinika.ru/wp-content/uploads/2025/04/Sertifikat_25.0265.026.pdf'
    },
    {
        title: 'Сертификат соответствия ГОСТ Р ИСО 9001-2015, ГОСТ Р ИСО 14001-2016 и ГОСТ Р 54934-2012',
        url: 'https://doclinika.ru/wp-content/uploads/2023/05/Sertifikat-sootvetstviya_2023.pdf'
    },
    {
        title: 'Международный сертификат ISO 9001:2015 органа Standcert d.o.o.',
        url: 'https://doclinika.ru/wp-content/uploads/2025/05/StandCert_Sertifikat-ISO_ru.jpg'
    },
    {
        title: 'Международный сертификат соответствия надлежащей лабораторной практике OECD GLP органа Standcert d.o.o.',
        url: 'https://doclinika.ru/wp-content/uploads/2025/05/StandCert_Sertifikat-OECD-GLP_ru.jpg'
    },
    {
        title: 'Сертификат ОС Эй Джей Эй Регистрарс ГОСТ Р ИСО 9001–2015 с аккредитацией Росаккредитации',
        url: 'https://doclinika.ru/wp-content/uploads/2025/05/AJAR_Sertifikat-GOST-R-ISO_ru.jpg'
    },
    {
        title: 'Сертификат ОС Эй Джей Эй Регистрарс ГОСТ 33044–2014',
        url: 'https://doclinika.ru/wp-content/uploads/2025/05/AJAR_Sertifikat_GOST-33044-2014_ru.jpg'
    },
    {
        title: 'Заключение о соответствии требованиям нормативных документов Евразийского экономического союза (ЕАЭС)',
        url: 'https://doclinika.ru/wp-content/uploads/2024/08/Zakljuchenie-o-sootvetstvii-trebovaniyam-normativnyh-dokumentov-Evrazijskogo-ekonomicheskogo-sojuza-EAES_2024.pdf'
    },
    {
        title: 'Лицензия на осуществление фармацевтической деятельности (хранение лекарственных средств для ветеринарного применения)',
        url: 'https://doclinika.ru/wp-content/uploads/2014/12/Litsenziya-na-farmdeyatel-nost-2016.pdf'
    },
    {
        title: 'Лицензия на осуществление фармацевтической деятельности (хранение лекарственных препаратов и лекарственных средств для медицинского применения)',
        url: 'https://doclinika.ru/wp-content/uploads/2023/10/Licenziya-na-farmacevticheskuju-deyatelnost_-L042-01149-47-00013691.pdf'
    },
    {
        title: 'Лицензия на осуществление деятельности в области использования возбудителей инфекционных заболеваний человека и животных (за исключением случая, если указанная деятельность осуществляется в медицинских целях) и генно-инженерно-модифицированных организмов III и IV степени потенциальной опасности, осуществляемой в замкнутых системах',
        url: 'https://doclinika.ru/wp-content/uploads/2022/04/Licenziya-na-osushhestvlenie-deyatelnosti-v-oblasti-ispolzovaniya-vozbuditelej-infekcionnyh-zabolevanij-cheloveka-i-zhivotnyh_2022.pdf'
    },
    {
        title: 'Лицензия на осуществление деятельности по обороту наркотических средств, психотропных веществ и их прекурсоров, культивированию наркосодержащих растений',
        url: 'https://doclinika.ru/wp-content/uploads/2023/09/Licenziya-NS-i-PV.pdf'
    }
]

export default function LitsenziiSertifikatyUdostovereniya() {
            ...
            <div className="bg-white border-b border-[#F28F20]/20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
                    <nav className="flex items-center text-sm text-gray-500">
                        ...
                        <span className="text-gray-900 font-medium">Лицензии, сертификаты, удостоверения</span>
                    </nav>
                </div>
            </div>
                    ...
                    <article className="flex-1 min-w-0">
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                            ...
                            <div className="px-6 sm:px-8 py-6 sm:py-8" style={{ background: 'linear-gradient(to right, #F28F20, #e07d10)' }}>
                                <h1 className="text-2xl sm:text-3xl font-bold text-white">Лицензии, сертификаты, удостоверения</h1>
                            </div>

                            {/* Content */}
                            <div className="px-6 sm:px-8 py-6 sm:py-8">
                                <p className="text-lg font-bold text-gray-900 mb-6">НПО «ДОМ ФАРМАЦИИ»</p>
