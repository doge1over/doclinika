...
const menuItems = [
    { href: '/o-nas', title: 'О нас' },{ href: '/vakansii', title: 'Вакансии' },{ href: '/doklinicheskie-issledovaniya', title: 'Доклинические исследования' },{ href: '/immunogennost-aktivnost', title: 'Иммуногенность и активность' },{ href: '/gruppa-gistologii-i-patomorfologii', title: 'Лаборатория гистологии и патоморфологии' },{ href: '/mikrobiologicheskaya-laboratoriya', title: 'Отдел микробиологии' },{ href: '/farmacevticheskaya-razrabotka', title: 'Фармацевтическая разработка' },{ href: '/gruppa-biohimii-i-gematologii', title: 'Лаборатория биохимии и гематологии' },{ href: '/laboratornye-zhivotnye', title: 'Лабораторные животные' },{ href: 'http://labanimalsjournal.ru/ru/contents/2018/2', title: 'Журнал «Лабораторные животные»', external: true },{ href: '/farmakokinetika', title: 'Фармакокинетика' },
    { href: '/oborudovanie-otdela', title: 'Оборудование отдела' },{ href: '/obespechenie-kachestva', title: 'Обеспечение качества' },{ href: '/provizorskaya-sluzhba', title: 'Провизорская служба' },{ href: '/spetsialisty', title: 'Специалисты' },{ href: '/policy', title: 'Политики' },{ href: '/litsenzii-sertifikaty-udostovereniya', title: 'Лицензии, сертификаты, удостоверения' },{ href: '/glavnaya', title: 'Сведения об образовательной организации' },{ href: '/category/news', title: 'Новости', active: true },{ href: '/kontakty', title: 'Контакты' },
]
...
const NEWS_CSS = `
.news-content { font-size: 15px; line-height: 1.7; color: #374151; }
.news-content p { margin-bottom: 16px; line-height: 1.7; color: #374151; font-size: 15px; }
.news-content div { margin-bottom: 12px; line-height: 1.7; color: #374151; }
.news-content span { line-height: 1.7; }
.news-content h2 { font-size: 20px; font-weight: 700; color: #111827; margin: 24px 0 12px; }
.news-content h3 { font-size: 18px; font-weight: 700; color: #111827; margin: 20px 0 10px; }
.news-content blockquote { border-left: 4px solid #F28F20; padding: 12px 20px; margin: 16px 0; background: #FFF7ED; border-radius: 0 8px 8px 0; font-style: italic; color: #374151; }
.news-content img {
    display: block;
...
.news-content a:hover { color: #e07d10; }
.news-content hr { border: none; border-top: 1px solid #e5e7eb; margin: 20px 0; }
`