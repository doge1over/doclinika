            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-purple-700 px-6 sm:px-8 py-6 sm:py-8">
                        ...
                        <p className="text-blue-100 text-sm">Сертификат на соответствие ГОСТ 33044-2014 № 19.0291.026 • Система менеджмента сертифицирована с 2016 г.</p>
                    </div>

                    <form onSubmit={handleSubmit} className="px-6 sm:px-8 py-6 sm:py-8 space-y-8">
                        
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600">Информация о Спонсоре исследования</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="md:col-span-2">
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Название организации *</label>
                                    <input type="text" name="organizationName" value={formData.organizationName} onChange={handleInputChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
                                </div>
                                <div className="md:col-span-2">
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Адрес организации *</label>
                                    <input type="text" name="organizationAddress" value={formData.organizationAddress} onChange={handleInputChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">ФИО контактного лица *</label>
                                    <input type="text" name="contactPerson" value={formData.contactPerson} onChange={handleInputChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Электронная почта *</label>
                                    <input type="email" name="contactEmail" value={formData.contactEmail} onChange={handleInputChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Телефон *</label>
                                    <input type="tel" name="contactPhone" value={formData.contactPhone} onChange={handleInputChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Дата оформления заявки</label>
                                    <input type="date" name="applicationDate" value={formData.applicationDate} onChange={handleInputChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
                                </div>
                            </div>
                        </section>

                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600">Цель исследования</h2>
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Опишите цель исследования</label>
                                    <textarea name="researchGoal" value={formData.researchGoal} onChange={handleInputChange} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" placeholder="Заполните в произвольной форме или выберите тип ниже"></textarea>
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">Планируемое исследование</label>
                                    <div className="flex flex-wrap gap-4">
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" name="researchType" value="regulatory" checked={formData.researchType === 'regulatory'} onChange={handleInputChange} className="w-4 h-4 text-blue-600 focus:ring-blue-500" />
                                            <span className="text-gray-700">Регуляторное</span>
                                        </label>
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" name="researchType" value="exploratory" checked={formData.researchType === 'exploratory'} onChange={handleInputChange} className="w-4 h-4 text-blue-600 focus:ring-blue-500" />
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600">Информация о дизайне исследования</h2>
                            
                            <div className="space-y-6">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                        <input type="checkbox" name="developProgram" checked={formData.developProgram} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                        <span className="text-gray-700">Разработка программы доклинических исследований</span>
                                    </label>
                                    <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                        <input type="checkbox" name="prepareLiteratureReview" checked={formData.prepareLiteratureReview} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="singleDoseToxicity" checked={formData.singleDoseToxicity} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Токсичность при однократном введении</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="doseRangingStudy" checked={formData.doseRangingStudy} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Поиск токсических доз (dose-ranging study)</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="repeatDoseToxicity" checked={formData.repeatDoseToxicity} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Токсичность при многократном введении</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="chronicToxicity" checked={formData.chronicToxicity} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Хроническая токсичность</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="reproductiveToxicity" checked={formData.reproductiveToxicity} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Репродуктивная токсичность</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="immunotoxicity" checked={formData.immunotoxicity} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Иммунотоксичность при однократном и курсовом введении</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="allergenicProperties" checked={formData.allergenicProperties} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Аллергизующие свойства</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="mutagenicity" checked={formData.mutagenicity} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Мутагенность</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="carcinogenicity" checked={formData.carcinogenicity} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Канцерогенность</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="localTolerance" checked={formData.localTolerance} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Местная переносимость</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="phototoxicity" checked={formData.phototoxicity} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Фототоксичность</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="addictivePotential" checked={formData.addictivePotential} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                            <span className="text-gray-700">Аддиктивный потенциал</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition cursor-pointer">
                                            <input type="checkbox" name="additionalToxStudies" checked={formData.additionalToxStudies} onChange={handleInputChange} className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500" />
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-purple-50 transition cursor-pointer">
                                            <input type="checkbox" name="pharmacokinetics" checked={formData.pharmacokinetics} onChange={handleInputChange} className="w-5 h-5 text-purple-600 rounded focus:ring-purple-500" />
                                            <span className="text-gray-700">Фармакокинетика</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-purple-50 transition cursor-pointer">
                                            <input type="checkbox" name="pharmacodynamics" checked={formData.pharmacodynamics} onChange={handleInputChange} className="w-5 h-5 text-purple-600 rounded focus:ring-purple-500" />
                                            <span className="text-gray-700">Фармакодинамика</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-purple-50 transition cursor-pointer">
                                            <input type="checkbox" name="toxicokinetics" checked={formData.toxicokinetics} onChange={handleInputChange} className="w-5 h-5 text-purple-600 rounded focus:ring-purple-500" />
                                            <span className="text-gray-700">Токсикокинетика</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-purple-50 transition cursor-pointer">
                                            <input type="checkbox" name="bioequivalence" checked={formData.bioequivalence} onChange={handleInputChange} className="w-5 h-5 text-purple-600 rounded focus:ring-purple-500" />
                                            <span className="text-gray-700">Биоэквивалентность</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-purple-50 transition cursor-pointer">
                                            <input type="checkbox" name="biopharmaceuticalStudies" checked={formData.biopharmaceuticalStudies} onChange={handleInputChange} className="w-5 h-5 text-purple-600 rounded focus:ring-purple-500" />
                                            <span className="text-gray-700">Биофармацевтические исследования в соответствии с ГФ</span>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-purple-50 transition cursor-pointer">
                                            <input type="checkbox" name="pharmacodynamicsStudy" checked={formData.pharmacodynamicsStudy} onChange={handleInputChange} className="w-5 h-5 text-purple-600 rounded focus:ring-purple-500" />
                                ...
                                <div>
                                    ...
                                    <textarea name="experimentalModelWishes" value={formData.experimentalModelWishes} onChange={handleInputChange} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"></textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="individualWishes" value={formData.individualWishes} onChange={handleInputChange} rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"></textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4">
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" name="previousStudiesExist" value="yes" checked={formData.previousStudiesExist === 'yes'} onChange={handleInputChange} className="w-4 h-4 text-blue-600 focus:ring-blue-500" />
                                            <span className="text-gray-700">Да</span>
                                        </label>
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" name="previousStudiesExist" value="no" checked={formData.previousStudiesExist === 'no'} onChange={handleInputChange} className="w-4 h-4 text-blue-600 focus:ring-blue-500" />
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-purple-600">Информация об исследуемом препарате</h2>
                            
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">Степень инновативности исследуемого препарата *</label>
                                    <select name="drugInnovativeness" value={formData.drugInnovativeness} onChange={handleInputChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="innName" value={formData.innName} onChange={handleInputChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Торговое наименование</label>
                                        <input type="text" name="tradeName" value={formData.tradeName} onChange={handleInputChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Действующее вещество(а)</label>
                                        <input type="text" name="activeSubstance" value={formData.activeSubstance} onChange={handleInputChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Лекарственная форма(ы)</label>
                                        <input type="text" name="dosageForm" value={formData.dosageForm} onChange={handleInputChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition" />
                                    </div>
                                </div>

                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Химическая группа, химическая структура, формула(ы)</label>
                                    <textarea name="chemicalStructure" value={formData.chemicalStructure} onChange={handleInputChange} rows={2} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition"></textarea>
                                </div>

                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Состав готовой лекарственной формы</label>
                                    <textarea name="composition" value={formData.composition} onChange={handleInputChange} rows={2} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition"></textarea>
                                </div>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Фармакологическая группа</label>
                                        <input type="text" name="pharmacologicalGroup" value={formData.pharmacologicalGroup} onChange={handleInputChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Условия хранения</label>
                                        <input type="text" name="storageConditions" value={formData.storageConditions} onChange={handleInputChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition" />
                                    </div>
                                </div>

                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Показания к применению</label>
                                    <textarea name="indications" value={formData.indications} onChange={handleInputChange} rows={2} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition"></textarea>
                                </div>
                            </div>
                        </section>

                        <div className="pt-6 border-t border-gray-200">
                            <button type="submit" className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
                                Отправить заявку
                            </button>
